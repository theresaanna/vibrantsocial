      ...
      headers: [
        ...
        },
        {
          ...
          value: [
            ...
            "connect-src 'self' https://*.ingest.us.sentry.io https://api.agechecker.net https://shield.projectarachnid.com https://discord.com https://www.googleapis.com https://api.anthropic.com wss://*.ably.io https://*.ably.io wss://*.ably-realtime.com https://*.ably-realtime.com wss://*.ably.net https://*.ably.net https://*.public.blob.vercel-storage.com https://vercel.com https://checkout.stripe.com https://billing.stripe.com",
