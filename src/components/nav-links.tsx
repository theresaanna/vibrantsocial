...
export function NavLinks({ username }: { username?: string | null }) {
  ...
  const links: NavLink[] = [
...

    {
      href: "/help",
      label: "Help",
      color: "hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-zinc-800 dark:hover:text-zinc-300",
      activeColor: "bg-zinc-100 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300",
      icon: (
        <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
