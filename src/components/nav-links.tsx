...
const hoverClass = "hover:bg-fuchsia-50 hover:text-fuchsia-500 dark:hover:bg-fuchsia-900/20 dark:hover:text-fuchsia-400";
const activeClass = "bg-fuchsia-50 text-fuchsia-500 dark:bg-fuchsia-900/20 dark:text-fuchsia-400";
...
export function NavLinks({ username }: { username?: string | null }) {
  ...
  return (
    <>
      ...
      {/* All nav links — order-2 on mobile (row 2), left-aligned; inline on sm+ */}
      <div className="order-2 flex w-full items-center gap-1 sm:order-none sm:w-auto">
