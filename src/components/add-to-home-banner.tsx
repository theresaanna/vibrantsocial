...
export function AddToHomeBanner() {
  ...
  return (
    <div className="mb-4 flex items-start gap-3 rounded-2xl bg-gradient-to-r from-fuchsia-50 to-blue-50 p-4 shadow-sm md:hidden dark:from-fuchsia-950/30 dark:to-blue-950/30">
