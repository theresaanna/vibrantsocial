    ...
    <div className={showMenu ? "relative z-[100]" : undefined}>
      ...
      {isQuote ? (
        <div className={`overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-700${showOverlay ? " bg-white shadow-lg dark:bg-zinc-900" : ""}`}>
          {/* Repost header — inside container */}
          <div
            className="flex items-center gap-1.5 border-b border-zinc-200 bg-zinc-100 px-4 py-2.5 text-xs text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400"
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-lg dark:bg-zinc-900">
          {/* Repost header — inside container */}
          <div
            className="flex items-center gap-1.5 border-b border-zinc-100 bg-zinc-50 px-4 py-2.5 text-xs text-zinc-500 dark:border-zinc-800 dark:bg-zinc-800/60 dark:text-zinc-400"
