...
import { getBioRevisions, restoreBioRevision } from "@/app/profile/actions";
...
interface BioRevisionHistoryProps {
  onClose: () => void;
  onRestore: (content: string) => void;
}

export function BioRevisionHistory({
  onClose,
  onRestore,
}: BioRevisionHistoryProps) {
  ...
  async function handleRestore() {
    ...
    setRestoring(true);
    const result = await restoreBioRevision(selectedId);
    setRestoring(false);
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative z-10 flex h-[80vh] w-[90vw] max-w-4xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-zinc-900">
        {/* Header */}
