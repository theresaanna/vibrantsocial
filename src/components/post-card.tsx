      ...
      <div className={`flex items-center gap-3 px-4 ${wallOwner ? "pt-2" : "pt-4"}`}>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            {post.hasCustomAudience && (
              <span className="flex items-center gap-0.5 rounded-full bg-violet-50 px-1.5 py-0.5 text-xs font-medium text-violet-600 dark:bg-violet-900/30 dark:text-violet-400" title="Custom audience">
