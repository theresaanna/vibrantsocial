  ...
  return createPortal(
    ...
    >
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900">
        ...
        {/* OAuth provider buttons — use form actions (not onClick) so Next.js
            properly handles the server-side redirect thrown by signIn(). */}
        <div className="space-y-2">
          <form
            action={startOAuthLink.bind(null, "google")}
            onSubmit={() => setOauthLoading("google")}
          >
            <button
              type="submit"
          ...
          <form
            action={startOAuthLink.bind(null, "discord")}
            onSubmit={() => setOauthLoading("discord")}
          >
            <button
              type="submit"
              disabled={oauthLoading !== null}
