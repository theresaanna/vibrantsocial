...
export function PostPageClient({
  ...
  const backLink = (
    <Link
      ...
      className={`mb-4 inline-flex items-center gap-1 text-sm ${hasWallOwnerTheme && !bare ? "profile-text-secondary" : "text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300"}`}
