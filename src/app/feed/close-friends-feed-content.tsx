...
/**
 * Server component that renders the close friends feed on the /feed page.
 */
export async function CloseFriendsFeedContent({ userId }: { userId: string }) {
  const [currentUser, closeFriendIds, closeFriendOfIds, blockedIds] = await Promise.all([
