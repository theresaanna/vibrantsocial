...
export async function MarketplaceContent({ userId }: MarketplaceContentProps) {
  ...
  return (
    <>
      <div className="mb-4 rounded-2xl bg-gradient-to-r from-fuchsia-50/60 to-blue-50/60 p-4 shadow-sm dark:from-fuchsia-950/20 dark:to-blue-950/20" data-testid="marketplace-notice">
