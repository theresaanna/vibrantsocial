...
export async function MarketplaceContent({ userId }: MarketplaceContentProps) {
  ...
  return (
    <>
      <div className="mb-4 rounded-2xl bg-gradient-to-r from-fuchsia-50 to-blue-50 p-4 shadow-sm dark:from-fuchsia-950/30 dark:to-blue-950/30" data-testid="marketplace-notice">
