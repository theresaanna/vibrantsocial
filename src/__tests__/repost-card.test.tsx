...
describe("RepostCard", () => {
  it("renders reposter name and reposted label", () => {
    render(
      <RepostCard repost={defaultRepost} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("shows quote-header testid for quote posts", () => {
    ...
    render(
      <RepostCard repost={quoteRepost} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("renders quote content when present", () => {
    ...
    render(
      <RepostCard repost={repostWithQuote} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("shows menu button for quote post author", () => {
    ...
    render(
      <RepostCard repost={repostWithQuote} currentUserId="u1" phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("does not show menu button for non-author", () => {
    ...
    render(
      <RepostCard repost={repostWithQuote} currentUserId="u99" phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("does not show menu button for simple reposts", () => {
    render(
      <RepostCard repost={defaultRepost} currentUserId="u1" phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
    expect(screen.queryByTestId("repost-menu-button")).toBeNull();
  });
  ...
  it("shows pinned indicator when repost is pinned", () => {
    ...
    render(
      <RepostCard repost={pinnedRepost} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} showPinnedIndicator />
    );
  ...
  it("shows edited indicator when repost was edited", () => {
    ...
    render(
      <RepostCard repost={editedRepost} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
  ...
  it("displays tags on quote posts", () => {
    ...
    render(
      <RepostCard repost={repostWithTags} phoneVerified={false} ageVerified={false} showGraphicByDefault={false} showNsfwContent={false} hideSensitiveOverlay={false} hideNsfwOverlay={false} />
    );
